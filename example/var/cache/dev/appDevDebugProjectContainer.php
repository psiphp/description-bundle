...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.app'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Ft5uQtnm-W', 0, (__DIR__.'/pools'));
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('B0Rb0CUTFT', 0, 'bzJC81ghbIkK9Y5g40hZrA', (__DIR__.'/pools'), NULL);
    }
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => $this->get('kernel.class_cache.cache_warmer'), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\AnnotationsCacheWarmer(${($_ = isset($this->services['annotations.reader']) ? $this->services['annotations.reader'] : $this->getAnnotations_ReaderService()) && false ?: '_'}, (__DIR__.'/annotations.php'), ${($_ = isset($this->services['cache.annotations']) ? $this->services['cache.annotations'] : $this->getCache_AnnotationsService()) && false ?: '_'}), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator'))));
    }
    ...
    {
        return $this->services['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, NULL, -1, -1, true, NULL, true);
    }
    ...
    {
        return $this->services['kernel.class_cache.cache_warmer'] = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\ClassCacheCacheWarmer(array(0 => 'Doctrine\\Common\\Annotations\\AnnotationRegistry', 1 => 'Symfony\\Component\\HttpFoundation\\ParameterBag', 2 => 'Symfony\\Component\\HttpFoundation\\HeaderBag', 3 => 'Symfony\\Component\\HttpFoundation\\FileBag', 4 => 'Symfony\\Component\\HttpFoundation\\ServerBag', 5 => 'Symfony\\Component\\HttpFoundation\\Request', 6 => 'Symfony\\Component\\HttpKernel\\Kernel', 7 => 'Symfony\\Component\\ClassLoader\\ClassCollectionLoader', 8 => 'Symfony\\Component\\ClassLoader\\ApcClassLoader'));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WiZi3GKTCJ', 0, 'bzJC81ghbIkK9Y5g40hZrA', (__DIR__.'/pools'), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PsiDescriptionBundle' => 'Psi\\Bundle\\Description\\PsiDescriptionBundle',
            ),
